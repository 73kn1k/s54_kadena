(define-namespace
    "n_a3321556d46dd4ab10645940d3d3425530f3aa25"
    (read-keyset "moderator_keyset") 
    (read-keyset "moderator_keyset")
  ) 
  
  (namespace "n_a3321556d46dd4ab10645940d3d3425530f3aa25")
  
  (define-keyset "n_a3321556d46dd4ab10645940d3d3425530f3aa25.admin" (read-keyset "moderator_keyset"))
  ...
  (module nft-policy-v1 GOVERNANCE
    ...
    (defconst ADMIN-KS:string "n_a3321556d46dd4ab10645940d3d3425530f3aa25.admin")
    ...
    (defun moderated-mint:bool
      ...
      (enforce-keyset "n_a3321556d46dd4ab10645940d3d3425530f3aa25.admin")
